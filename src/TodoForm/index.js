    ...
    return(
        ...
        <div className="w-full max-w-md bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <form onSubmit={onSubmit} className="flex flex-col">
            ...
            onChange={onChange}
            placeholder="TODO..." 
            className=" resize-none bg-gray-700 text-gray-200 border-0 rounded-md p-2 mb-4 focus:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" type="email"/>
